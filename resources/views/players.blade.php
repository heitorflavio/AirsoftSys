                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <form action="/consulta/players" method="GET">
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $player->sangue }}</td>
                                                @hasPermission(1)
                                                <td><a href="/consulta/player/{{$player->id}}" class="btn-link">Editar</a></td>
                                                @endhasPermission
                                                @hasPermission(0)
                                                <td><a href="#" class="" disabled>Editar</a></td>
                                                @endhasPermission
                                ...
                                <div class="card-footer clearfix d-flex justify-content-center">
                                    @include('layouts.custom_pagination')
                                </div>
